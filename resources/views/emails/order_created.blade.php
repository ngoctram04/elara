...
<table width="600" cellpadding="0" cellspacing="0" style="background:#ffffff; border-radius:8px; overflow:hidden;">
        ...
        <td style="padding:30px;">
            @if($forAdmin)
                <p style="margin:0; font-size:16px;">
                    Hệ thống vừa ghi nhận một đơn hàng mới.
                </p>
            @else
                ...
                <p style="margin:0; color:#555; line-height:1.6;">
                    Cảm ơn bạn đã mua sắm tại ELARA. Đơn hàng của bạn đã được ghi nhận và đang được xử lý.
                </p>
            @endif
        </td>
    </tr>
    ...
    <tr>
        <td style="padding:0 30px 20px 30px;">
            ...
            <div style="margin-top:15px; font-size:14px; color:#444; line-height:1.6;">
                <p style="margin:4px 0;"><strong>Khách hàng:</strong> {{ $order->receiver_name }}</p>
                <p style="margin:4px 0;"><strong>SĐT:</strong> {{ $order->receiver_phone }}</p>
                <p style="margin:4px 0;"><strong>Địa chỉ:</strong> {{ $order->receiver_address }}</p>
            </div>
        </td>
    </tr>
        ...
        <td style="padding:0 30px 30px 30px;">
            ...
            <table width="100%" cellpadding="10" cellspacing="0" style="border-collapse:collapse; font-size:14px;">
                ...
                <tr style="background:#f3f4f6;">
                    <th align="left" style="border-bottom:1px solid #e5e7eb;">Sản phẩm</th>
