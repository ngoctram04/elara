...
>
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6 mb-4">
                    ...
                    <ul class="footer-links">
                        ...
                        <li><a href="{{ route('policy') }}">Điều khoản dịch vụ</a></li>
                        <li><a href="{{ route('policy') }}">Hướng dẫn mua hàng</a></li>
                    </ul>
                </div>
    ...
    <div id="ai-chat-box" class="ai-chat-box" style="display:none;">
        <div class="ai-header">
            ...
            <button type="button" onclick="toggleAIChat()" class="btn-close btn-close-white"></button>
        </div>
        ...
        <div class="ai-input">
            ...
            <button type="button" onclick="sendAI()">Gửi</button>
        </div>
    </div>
