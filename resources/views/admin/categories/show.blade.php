...
<th width="80" class="text-center text-muted">
Mã
</th>
...
<span class="badge
{{ $child->products_count > 0 ? 'bg-primary' : 'bg-secondary' }}">
...
{{-- FOOTER --}} <a href="{{ route('admin.categories.index') }}"
