...
<form method="POST"
    ...
    <div class="card-body p-4">
        ...
        <div class="d-flex flex-wrap justify-content-between align-items-center gap-2 mb-3">
            <div>
                <h5 class="fw-semibold mb-1">Sản phẩm / biến thể áp dụng</h5>
                <small class="text-muted">
                    Danh sách chỉ hiện khi nhập từ khóa tìm kiếm để tránh xổ quá dài.
                </small>
            </div>
        ...
        <div class="mb-3">
            ...
            <small class="text-muted">
                Ví dụ: son, serum, đỏ nâu, 3CE, 01, 50ml...
            </small>
        </div>
                ...
                <div class="promotion-product-card d-none"
                        ...
                        <div class="promotion-product-info d-flex align-items-start gap-3">
                            ...
                            <div class="flex-grow-1 min-w-0">
                                ...
                                <div class="small text-muted">
                                    ...
                                    <span class="selected-count-wrap {{ $checkedCount > 0 ? '' : 'd-none' }}">
                                        • Đã chọn <span class="selected-count">{{ $checkedCount }}</span>
                                    </span>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="promotion-variants {{ $shouldOpen ? '' : 'd-none' }}">
                        @foreach ($product->variants as $variant)
                            @php
                                $isChecked = in_array((int) $variant->id, $selectedVariantIds);
                            @endphp
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    @else
        const hasInitialSelected = [...document.querySelectorAll('.variant-checkbox:checked')].length > 0;
