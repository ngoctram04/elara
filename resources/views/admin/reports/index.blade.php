                ...
                <div class="card shadow-sm">
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-between mb-2">
                            ...
                            <a href="{{ route('admin.reports.products', ['from' => $from, 'to' => $to]) }}" class="small">
                                Xem tất cả
                            </a>
                        </div>
                        ...
                        <table class="table table-sm">
                            ...
                            @empty
                                <tr>
                                    <td class="text-center text-muted">Không có dữ liệu</td>
                                </tr>
                            @endforelse
                        </table>
                ...
                <div class="card shadow-sm">
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-between mb-2">
                            ...
                            <a href="{{ route('admin.reports.slowProducts') }}" class="small">
                                Xem tất cả
                            </a>
                        </div>
                ...
                <div class="card shadow-sm">
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-between mb-2">
                            ...
                            <a href="{{ route('admin.reports.customers') }}" class="small">
                                Xem tất cả
                            </a>
                        </div>
