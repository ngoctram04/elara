...
<td class="text-right">{{ number_format($cost) }} đ</td>
<td class="text-right">{{ number_format($profit) }} đ</td>
...
<td class="text-center">{{ number_format($cancelRate ?? 0,1) }}%</td>
...
<tr>
<td class="text-right">{{ number_format($shipping) }} đ</td>
<td class="text-right">{{ number_format($discount) }} đ</td>
<td class="text-right">{{ number_format($cost) }} đ</td>
<td class="text-right">{{ number_format($inventory->total_value ?? 0) }} đ</td>
<td class="text-right">{{ number_format($totalImport ?? 0) }} đ</td>
</tr>
</table>
...
<td class="text-right">{{ number_format($p->revenue) }} đ</td>
<td class="text-right">{{ number_format($p->profit) }} đ</td>
</tr>
...
<td class="text-right">{{ number_format($c->spending) }} đ</td>
</tr>
